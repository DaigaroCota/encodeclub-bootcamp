...
contract DogCoinUpgradeableV2 is ERC1967UpgradeUpgradeable {
  ...
  // Constructor included to automatically mark it as initialized when it is deployed:
  ...
  function changeNewVariable(uint256 _new) public {
    newVariable = _new;
  }
